...
window.onload=function(){
	...
	request.open("post","ReadCookies.asp",true);		
	request.onBack = function(){			
		var data = request.getText();//alert(data);
		if(data!=""&&data!="201"){setCookie("Ali_RegUser_Client",data);showHeaderUserInfo();}			
	}
	request.send();	
	...
	var tv = new TransformView("idTransformView", "idSlider", 180, 3, {
