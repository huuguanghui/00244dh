...
alicallwin('open',URLEncode(number2),0,'msg')
	...
	if(action == 'open') {
		...
		//if(!$('pmlayer')) {  //edit by yang
			...
			$('pmlayer').innerHTML = '<div style="width: 920px; background: #666666; margin: 5px auto; text-align: left">' +
				...
				'<div onmouseover="pmwindrag(this)" style="cursor: move; position: relative; left: 0px; top: 0px; width: 920px; height: 31px; margin-bottom: -30px;background:url(http://210.83.225.10/alicall2008/images/headerbg.gif) repeat-x 50%; border-bottom: 1px solid #CAD9EA;"><span style=" margin-left:12px;font-size:14px;color:#005C89;font-weight:bold;height: 32px; line-height: 32px; ">'+title+'</span></div>' +
				'<a href="javascript:alicallwin(\'close\')" ><img style="position: absolute; right: 20px; top: 12px" src="http://210.83.225.10/alicall2008/images/close.gif" title="关闭" border="0"/></a>' +
				'<div id="pmwinmask" style="margin-top: 30px; position: absolute; width: 100%; height: 100%; display: none;overflow-x:hidden;"></div><iframe id="pmframe" name="pmframe" style="width:' + pmwidth + 'px;height:100%;margin-top: 30px; " allowTransparency="true" frameborder="0" scrolling="no"></iframe></div></div>'+'<iframe src="JavaScript:false" style="position:absolute; visibility:inherit; top:3px; left:0px; width:920px; height:587px; z-index:-1; filter="progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)";"></iframe>';
		//}
		...
		//for(i = 0;i < objs.length; i ++) {
			//if(objs[i].attributes['oldvisibility']) {
				...
				//div.parentNode.removeChild("pmlayer");   
			//}
	//	}
		//hiddenobj = new Array();
